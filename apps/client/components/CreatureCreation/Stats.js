...
import StatModal from "components/CreatureProfile/CreatureStats/components/Stat/StatModal";
import { HTMLEditor } from "components/HTMLEditor/HTMLEditor";
import { D20 } from "components/icons/D20";
import { useRouter } from "next/router";
import { useState } from "react";
import { stats, checks, saves, skills } from "../../helpers/json/customizable_stats.json";
            ...
            <Grid container spacing={3}>
              ...
              {Object.keys(creature.stats?.abilityScores)?.map((key, index) => {
                ...
                return (
                  ...
                  >
                    <ButtonBase onClick={() => setSelectedStat(key)}>
