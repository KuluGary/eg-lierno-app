    ...
    >
      ...
      <Grid container spacing={3}>
                ...
                <>
                  <Grid item laptop={12}>
                    <Autocomplete
                      ...
                      renderInput={(params) => <TextField {...params} label={"A voluntad"} />}
                  ...
                  <Grid item laptop={12}>
                    <Autocomplete
                      ...
                      getOptionLabel={(option) => option.name}
                      options={spellAutocomplete.sort()}
                      renderInput={(params) => <TextField {...params} label={"3/día"} />}
                      renderTags={(value, getTagProps) =>
                        value.map((option, index) => (
                          <Chip key={index} variant="outlined" label={option.name} {...getTagProps({ index })} />
                        ))
                  ...
                  <Grid item laptop={12}>
                    <Autocomplete
                      ...
                      getOptionLabel={(option) => option.name}
                      options={spellAutocomplete.sort()}
                      renderInput={(params) => <TextField {...params} label={"2/día"} />}
                      renderTags={(value, getTagProps) =>
                        value.map((option, index) => (
                          <Chip key={index} variant="outlined" label={option.name} {...getTagProps({ index })} />
                        ))
                  ...
                  <Grid item laptop={12}>
                    <Autocomplete
                      ...
                      getOptionLabel={(option) => option.name}
                      options={spellAutocomplete.sort()}
                      renderInput={(params) => <TextField {...params} label={"1/día"} />}
                      renderTags={(value, getTagProps) =>
                        value.map((option, index) => (
                          <Chip key={index} variant="outlined" label={option.name} {...getTagProps({ index })} />
                        ))
                      ...
                      hasSpellSlotsOfLevel(level) && (
                        <Grid item laptop={12}>
                          <Autocomplete
                            ...
                            renderInput={(params) => <TextField {...params} label={getSpellLevelText(level)} />}
                            onChange={(event, newData) => {
                              const value = event.target.value;
        ...
        <Grid item laptop={3} sx={{ display: "flex", flexDirection: "column" }}>
          <FormControlLabel control={<Checkbox inputProps={{ "aria-label": "Material" }} />} label="Material" />
          <FormControlLabel control={<Checkbox inputProps={{ "aria-label": "Somático" }} />} label="Somático" />
          <FormControlLabel control={<Checkbox inputProps={{ "aria-label": "Verbal" }} />} label="Verbal" />
        </Grid>
      </Grid>
      <ModalFooter
        onClose={onClose}
